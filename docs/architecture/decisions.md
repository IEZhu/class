...
инвайт-ссылки отклонены — почтового сервиса в стеке нет, ссылку всё равно
передавать руками, а таблица `invites` и страница активации — лишняя
механика на 55 пользователей. Саморегистрация отклонена: домен публичный.
